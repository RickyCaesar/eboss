                ...
                <div class="card mb-3 widget-content bg-grow-early">
                    <div class="widget-content-wrapper text-white">
                        ...
                        <div class="widget-content-right">
                            <div class="widget-numbers text-white">
                                <i class="fa-solid fa-rupiah-sign"></i>
                                <span>{{number_format(RDev::TBOS('pagu_bosnas', 'Negeri'))}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3 widget-content bg-night-fade">
                    <div class="widget-content-wrapper text-white">
                        ...
                        <div class="widget-content-right">
                            <div class="widget-numbers text-white">
                                <i class="fa-solid fa-rupiah-sign"></i>
                                <span>{{number_format(RDev::TBOS('pagu_bosnas', 'Swasta'))}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3 widget-content bg-grow-early">
                    <div class="widget-content-wrapper text-white">
                        ...
                        <div class="widget-content-right">
                            <div class="widget-numbers text-white">
                                <i class="fa-solid fa-rupiah-sign"></i>
                                <span>{{number_format(RDev::TBOS('pagu_bosda', 'Negeri'))}}</span>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="card mb-3 widget-content bg-night-fade">
                    <div class="widget-content-wrapper text-white">
                        ...
                        <div class="widget-content-right">
                            <div class="widget-numbers text-white">
                                <i class="fa-solid fa-rupiah-sign"></i>
                                <span>{{number_format(RDev::TBOS('pagu_bosda', 'Swasta'))}}</span>
                            </div>
                        </div>
                    </div>
                </div>
