                    ...
                    <div class="widget-content-wrapper text-white">
                        ...
                        <div class="widget-content-right">
                            <div class="widget-numbers text-white">
                                ...
                                <span><?php echo e(number_format(RDev::TPD())); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="widget-content-wrapper text-white">
                        ...
                        <div class="widget-content-right">
                            <div class="widget-numbers text-white">
                                ...
                                <span><?php echo e(number_format(RDev::TS())); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="widget-content-wrapper text-white">
                        ...
                        <div class="widget-content-right">
                            <div class="widget-numbers text-white">
                                ...
                                <span><?php echo e(number_format(RDev::TBOS('pagu_bosnas'))); ?></span>
                            </div>
                        </div>
                    </div>
                </div>
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('Layouts.Index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/d/#Ricky's/Code/eboss/resources/views/Pages/Dashboards/DashboardD.blade.php ENDPATH**/ ?>