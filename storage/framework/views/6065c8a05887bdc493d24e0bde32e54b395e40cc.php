                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-5 text-right">
                                <button class="btn-shadow mr-3 btn btn-primary text-white font-weight-bold"
                                    style="display: inline;" id="UbahBosnas" onclick="UbahBosnas()">Ubah</button>
                                <button class="btn-shadow mr-3 btn btn-danger text-white font-weight-bold"
                                    style="display: none;" id="CloseBosnas" onclick="BatalBosnas()">Batal</button>
                                <button class="btn-shadow mr-3 btn btn-success text-white font-weight-bold"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('Layouts.Index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /mnt/d/#Ricky's/Code/eboss/resources/views/Pages/DataPokokSekolah/SatuanHarga.blade.php ENDPATH**/ ?>