                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-5 text-right">
                                ...
                                <a href="<?php echo e(route('data-pokok-pendidikan.export')); ?>" class="btn-shadow btn btn-danger text-white font-weight-bold">Export</a>
                            </div>
                        </div>
                            ...
                            <table id="example" class="table table-hover table-bordered">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><a class="btn-shadow btn btn-primary text-white font-weight-bold" href="<?php echo e(route('data-pokok-pendidikan.edit', $data->id)); ?>">Edit</a></td>
                                    </tr>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="FormImport" action="<?php echo e(route('data-pokok-pendidikan.import')); ?>" method="post"
...
<?php $__env->stopPush(); ?>
<?php echo $__env->make('Layouts.Index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\Project\eboss\resources\views/Pages/DataPokokSekolah/DataPokokPendidikan.blade.php ENDPATH**/ ?>